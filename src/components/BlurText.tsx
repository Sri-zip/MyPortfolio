...
const BlurText: React.FC<BlurTextProps> = ({
  ...
  return (
    <span ref={ref as any} className={className} style={{ display: 'inline-flex', flexWrap: 'wrap' }}>
      {elements.map((segment, index) => {
        ...
        // use provided easing if possible, otherwise fallback
        spanTransition.ease = easing as any;
