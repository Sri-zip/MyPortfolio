      ...
      <div className="container mx-auto text-center relative z-10 max-w-7xl">
        <div className="max-w-5xl mx-auto">
          ...
          >
            ...
            >
              <span className="relative z-10 font-ui font-medium text-base sm:text-base">View My Work</span>
            ...
            <button
              ...
              style={{ transform: 'translateZ(0)' }}
            >
              <span className="relative z-10 font-ui font-medium text-base sm:text-base">Get in Touch</span>
