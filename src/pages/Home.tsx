  ...
  return (
    <section className="min-h-screen flex flex-col items-center justify-center relative">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        {/* Floating elements with inner glow */}
        {[...Array(6)].map((_, i) => (
          <motion.div
            key={i}
            className="absolute"
          ...
          >
            <div className="relative">
              <div className="w-64 h-64 rounded-full blur-3xl animate-float-smooth opacity-10 bg-gradient-to-br from-accent-500/20 to-accent-400/20"></div>
      ...
      <div className="container mx-auto px-6 text-center relative z-10">
        <div className="max-w-4xl mx-auto">
          ...
          >
            <h1 className="text-7xl md:text-9xl font-bold mb-6 font-oregano">
          ...
          <motion.h2
            className="text-2xl md:text-3xl text-white/90 font-oregano mb-12 relative"
            initial={{ opacity: 0, y: 30 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            ...
            >
              <span className="relative z-10 font-medium font-nunito">View My Work</span>
            ...
            >
              <span className="relative z-10 font-medium font-nunito">Get in Touch</span>
